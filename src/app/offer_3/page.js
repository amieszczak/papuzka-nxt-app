            ...
            <article>
                <div className="page-o1">
                    ...
                    <div className="middle-page-text">
                        ...
                        prowadzone w grupach kilkuosobowych. Udział dziecka w
                        zajęciach poprzedzony jest diagnozą funkcjonowania
                        emocjonalno-społecznego dziecka i wywiadem z Rodzicami.
                        Zajęcia TUS mają na celu rozwinięcie kompetencji społecznych w
                        tym rozpoznawania i reagowania na swoje i cudze emocje, dobrej
                        komunikacji czy współpracy w grupie.
                        </p>
                        ...
                        <li>
                            ...
                            to zajęcia koncentrujące się na wspieraniu rozwoju
                            kompetencji społecznych, emocjonalnych i komunikacyjnych
                            dostosowane do potrzeb i możliwości uczestników.
                        </li>
                        <li>
                            <h3>TUS dla dzieci z ADHD</h3>
                            to w dużej mierze praca nad regulacją procesu pobudzenia i
                            hamowania, tak aby uczeń z wyzwaniem rozwojowym funkcjonował
                            w grupie z większą uwagą. Podczas zajęć pracuje się nad
                        ...
                        <li>
                            ...
                            grupą. Praca z wycofaną osobą często rozpoczyna się od pracy
                            w diadzie (tylko dwoje dzieci), tak aby oswajanie się w
                            byciu w kontakcie odbywało się w jak najbardziej
                    ...
                    <aside>
                        ...
                        <div className="metric-info">
                            ...
                            <p>
                            12 cotygodniowych spotkań około 60 minut raz w tygodniu
                            </p>
                        </div>
                        </div>
                        ...
                        <div className="metric">
                        <div className="metric-icon">
                            <img className="home" src="img/aside/offer_3/u_home-alt.svg" />
                        </div>
                        ...
                        <div className="metric-info">
                            ...
                            <p>
                            plan zakłada ćwiczenia utrwalające do wykonania w domu
                            </p>
                        </div>
                        </div>
                        ...
                        <div className="metric">
                        <div className="metric-icon">
                            <img className="chat" src="img/aside/offer_3/u_chat-info.svg" />
                        </div>
                        ...
                        <div className="metric-info">
                            ...
                            <p>
                            konsultacja z rodzicem po zakończeniu treningu- do 30
                            minut
                            </p>
                        </div>
                        </div>
                        ...
                        <div className="metric">
                        <div className="metric-icon">
                            <img className="award" src="img/aside/offer_3/award-alt.svg" />
                        </div>
                ...
                <div className="page-o1-1">
                    ...
                    <ul>
                        <li>
                        Rozpoznawanie emocji swoich i innych w poszczególnych
                        sytuacjach
                        </li>
                        ...
                        <li>
                        Poznanie sposobów reagowania na zaczepki i agresję innych
                        wobec nas
                        </li>
                        ...
                        <li>
                        Nauka rozpoznawania sytuacji, w której powinniśmy prosić o
                        pomoc
                        </li>
