import './offer_2.css';
import { Contact } from '../component sets/contact/contact.js'
                ...
                <div className="page_o1">
                    <section className="west">
                        <div className="middle-page-text">
                            ...
                            jest uzależniony od typu trudności oraz indywidualnej
                            motywacji pacjenta. Pracujemy w oparciu o metody
                            niedyrektywne, w zabawie i w relacji, z uwzględnieniem
                            indywidualnych potrzeb każdej osoby. Terapia logopedyczna
                            prowadzona jest z wykorzystaniem terapii miofunkcjonalnej.
                            Logopeda/ neurologopeda prowadzi terapię holistycznie,
                            ćwiczymy połykanie, pozycję spoczynkową języka oraz wykonujemy
                            ...
                            <li>
                                poprawienie jakości funkcji językowej, oddechowej,
                                fonacyjnej
                            </li>
                        ...
                        <aside>
                            ...
                            <div className="metric">
                            <div className="metric-icon">
                                <img className="eye" src="img/aside/oferta_terapia/u_eye.svg" />
                            </div>
